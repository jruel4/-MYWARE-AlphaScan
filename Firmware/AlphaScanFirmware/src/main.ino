...
// std::map<String, uint8_t> COMMAND_MAP_2_int;
//
// char map_buf[30]; // adc register map buffer
//
//
// ////////////////////////////////////////////////////////////////////////////////
// // ADS1299 SPI OPCODES
...
// //        }
// //
//         // Perform extraction on rx_buf using no dynamic memory allocation
//
//         // first check if 'bbb' and 'eee' are present
//         char* begin  = strstr(rx_buf, "bbb");
//         char* end = strstr(rx_buf, "eee");
//         if (begin != NULL && end != NULL) {
//             Serial.println("C string found successful");
//
//             // Parse out register map
//             char map_buf_raw[150] = {0};
//             std::advance(begin, 3);
//             std::strncpy(map_buf_raw, begin, end-begin);
//
//             Serial.print("parsed reg map: "); Serial.println(map_buf_raw);
//
//             // parse map_buf_raw into condensed global map_buf
//             int idx = 0;
//             char* reg = std::strtok(map_buf_raw, ",");
//             while(reg != NULL) {
//                 map_buf[3+idx++] = (char)std::atoi(reg);
//                 reg = std::strtok(0, ",");
//             }
//             Serial.println("Dumptin map_buf...");
//             int i;
//             for (i=0; i<24; i++) {
//                 Serial.printf("%d,",(int)map_buf[i+3]);
//             }
//         }
//         else {
//             Serial.println("C string not found = failure");
//         }
//     }
//
//     ////////////////////////////////////////////////////////////////////////////
...
//     delay(1);
// }
// >>>>>>> a2334e9d2b1647b7ccc5ff1f68c74e8e9e58e73f
