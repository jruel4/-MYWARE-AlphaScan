...
class DeviceCluster:
    ...
    def __init__(self, num_devices = 1, starting_port = 50007):
        self.num_devices = num_devices
        self.dev = [AlphaScanDevice(starting_port+i) for i in range(num_devices)]
...
>>>>>>> 6873247a32c460b20a90c37beba1e45bc25f6270
